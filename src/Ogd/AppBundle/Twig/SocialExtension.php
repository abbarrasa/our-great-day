...
class SocialExtension extends \Twig_Extension
{
     ...
     * @param null $tranlationDomain
     * @return string
     */
    public function facebookLinkFunction($content = '', array $attributes = array(), $tranlationDomain = null)
    {
        $defaults   = [
            'title'   => $this->translator->trans('frontend.menu.share', ['%site%' => 'Facebook'], $tranlationDomain),
     ...
     * @return string
     */
    public function twitterLinkFunction($content = '', array $attributes = array(), $tranlationDomain = null)
    {
        $defaults   = [
            'title'   => $this->translator->trans('frontend.menu.share', ['%site%' => 'Twitter'], $tranlationDomain),
            'onclick' => "javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;",
            'target' => '_blank'
        ];
        $attributes = array_merge($defaults, $attributes);
     ...
     * @return string
     */
    public function googleplusLinkFunction($content = '', array $attributes = array(), $tranlationDomain = null)
    {
        $defaults   = [
            'title'   => $this->translator->trans('frontend.menu.share', ['%site%' => 'Google+'], $tranlationDomain),
